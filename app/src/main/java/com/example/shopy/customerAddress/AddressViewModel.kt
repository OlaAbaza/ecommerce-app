package com.example.shopy.customerAddress
...
class AddressViewModel(val remoteDataSource: RemoteDataSource,application: Application) : AndroidViewModel(application) {
